 ...
 * This file demonstrates how to integrate Chainpulse with a web frontend
 */

// For React/Vue/Angular applications
export class ChainpulseClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ChainpulseClient(provider, contractAddress);
